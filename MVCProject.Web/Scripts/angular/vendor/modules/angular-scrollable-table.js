    ...
    angular.module('scrollable-table', [])
      .directive('scrollableTable', ['$timeout', '$q', '$parse', function ($timeout, $q, $parse) {
          return {
              ...
              template: '<div class="scrollableContainer" ng-style="{height: scrollHeight?scrollHeight:500}">' +
              ...
              controller: ['$scope', '$element', '$attrs', function ($scope, $element, $attrs) {
                  ...
                  if (typeof $scope.scrollHeight == "undefined" || $scope.scrollHeight == "") {
                      $scope.scrollHeight = 300;
                  }

                  // Apply dynamic height to scroll div
                  $scope.applyHeight = function () {
                      var height = $scope.scrollHeight;
                  ...
                  */
                  ...
                  function fixHeaderWidths() {
                      ...
                      //if ($element.find("div .ng-scope .ng-isolate-scope:not(:has(.box))").length) {
                      //    $element.find("div .ng-scope .ng-isolate-scope:not(:has(.box))").wrapInner('<div class="box"></div>');
                      //}
