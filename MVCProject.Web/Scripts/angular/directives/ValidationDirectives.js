...
// compareTo directive
angular.module("MVCApp").directive('compareTo', function () {
    return {
        require: "ngModel",
        scope: {
...
angular.module("MVCApp").directive('validateEmail', function () {
...
+91 (123) 456-7890
*/
angular.module("MVCApp").directive('contactNumber', function() {
  return {
    require: 'ngModel',
    link: function(scope, elm, attrs, ctrl) {
...
angular.module("MVCApp").directive('integer', function() {
  return {
    require: 'ngModel',
    link: function(scope, elm, attrs, ctrl) {
...
angular.module("MVCApp").directive('validDecimal',function(){
  return{
    require: "ngModel",
    link: function(scope, elm, attrs, ctrl){
