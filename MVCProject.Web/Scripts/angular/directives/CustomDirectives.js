// Autofocus directive
angular.module("MVCApp").directive('ngFocus', ['$timeout', function ($timeout) {
    return {
...
//table-responsive
angular.module("MVCApp").directive('tableResponsive', ['$timeout', '$window', function ($timeout, $window) {
    return {
        restrict: 'A',
        link: function (scope, element, attrs) {
            $timeout(function () {
...
angular.module("MVCApp").directive('checkboxAll', function () {
...
//    angular.module("MVCApp").directive('fieldset', function () {
//        return {
//            restrict: 'E',
//            scope: {
//                ngDisabled: '='
...
angular.module("MVCApp").directive("limitTo", [function () {
    return {
        restrict: "A",
...
angular.module("MVCApp").directive('numbersOnly', function () {
    return {
        require: 'ngModel',
...
angular.module("MVCApp").directive('fallbackSrc', function () {
    var fallbackSrc = {
...
angular.module("MVCApp").directive('countTo', ['$timeout', function ($timeout) {
    return {
        replace: false,
        scope: true,
        link: function (scope, element, attrs) {
...
angular.module("MVCApp").directive("angularTooltip", [function () {
    return {
        link: function ($scope, $element, $attrs) {
