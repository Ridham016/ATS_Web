angular.module("MVCApp").config(["$provide", function ($provide) {
...
angular.module("MVCApp").controller('UploadLocalImageController', ['$rootScope', '$scope', '$http', '$uibModalInstance', function ($rootScope, $scope, $http, $uibModalInstance) {
