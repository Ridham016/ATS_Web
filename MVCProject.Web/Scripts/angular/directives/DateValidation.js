...
angular.module("MVCApp").directive('compareToDate', function () {
    return {
        require: "ngModel",
        scope: {
...
angular.module("MVCApp").directive('dateLowerThan', ["$filter", '$rootScope', function ($filter, $rootScope) {
    return {
        require: 'ngModel',
...
angular.module("MVCApp").directive('dateGreaterThan', ["$filter", '$rootScope', function ($filter, $rootScope) {
    return {
        require: 'ngModel',
        link: function (scope, elm, attrs, ctrl) {
            var validateDateRange = function (inputValue) {
