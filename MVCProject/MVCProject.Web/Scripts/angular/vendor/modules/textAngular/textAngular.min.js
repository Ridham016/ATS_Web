                                        ...
                                        if (y === t) {
                                            ...
                                            if (y.match(f)) p.wrap(m);
                                                ...
                                                for (r = a.getOnlySelectedElements(), 0 === r.length && (r = [p[0]]), o = 0; o < r.length; o++)
                                                    if (3 === r[o].nodeType || !r[o].tagName.match(e))
                                                        for (; 3 === r[o].nodeType || !r[o].tagName || !r[o].tagName.match(e); ) r[o] = r[o].parentNode;
                            ...
                            if (l.events = {}, F) {
                                var _ = !1,
                                    aa = function (c) {
                                        if (c && c.trim().length) {
                                            ...
                                            /<li(\s.*)?>/i.test(c) && /(<ul(\s.*)?>|<ol(\s.*)?>).*<li(\s.*)?>/i.test(c) === !1 && (c = c.replace(/<li(\s.*)?>.*<\/li(\s.*)?>/i, "<ul>$&</ul>")), A && (c = A(l, {
                                                $html: c
                                            }) || c), c = a(c, "", K), m.insertHtml(c, v[0]), b(function () {
                                ...
                                if (v.on("keyup", l.events.keyup = function (a, c) {
                                    ...
                                    if (U && b.cancel(U), !H && !L.test(a.keyCode)) {
                                        ...
                                        var i = Y();
                                        if ("" !== B && "" === i.trim()) ja(B), m.setSelectionToElementStart(v.children()[0]);
                                        else if ("<" !== i.substring(0, 1) && "" !== w.taDefaultWrap) {
                                            var j = f.rangy.saveSelection();
                ...
                return {
                    ...
                    link: function (m, n, o, p) {
                                ...
                                var e = d.height / d.width,
                                    f = function (b) {
                                        var c = {
                                            ...
                                            f = void 0 !== o.taResizeForceAspectRatio,
                                            g = o.taResizeMaintainAspectRatio,
                                            h = f || g && !b.shiftKey;
                                        if (h) {
                                            var i = c.y / c.x;
                                        ...
                                        j.css('height', Math.round(Math.max(0, c.y))),
                                        j.css('width', Math.round(Math.max(0, c.x))),
                                        j.css("height", Math.round(Math.max(0, c.y) + "px")),
                                        j.css("width", Math.round(Math.max(0, c.x) + "px")),
                        ...
                        if (m.$watch("html", function (a, b) {
                            ...
                            // Added by developer class="custom-top-navigation"
                            var G = angular.element('<div text-angular-toolbar name="textAngularToolbar' + B + '" class="custom-top-navigation">');
