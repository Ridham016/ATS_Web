...
var DorfKetalApp = angular.module("DorfKetalMVCApp", angularmodule);

//BEGIN App Run
angular.module("DorfKetalMVCApp").run(["$rootScope", DorfKetalMVCAppRun]);
...
//BEGIN App config
angular.module("DorfKetalMVCApp").config(["$httpProvider", SAFEZydusAppConfig]);
