...
angular.module("DorfKetalMVCApp").filter('toDateString', ["$filter", "$rootScope", function ($filter, $rootScope) {
...
//Custom Filter for Date ETC...
angular.module("DorfKetalMVCApp").filter('toDate', ["$filter", "$rootScope", function ($filter, $rootScope) {
...
//Custom Filter for Date ETC...
angular.module("DorfKetalMVCApp").filter('toDateTime', ["$filter", "$rootScope", function ($filter, $rootScope) {
    return function (input) {
        if (input == undefined || input == null || input == '') {
            return input;
        }
...
angular.module("DorfKetalMVCApp").filter('joinBy', function () {
...
angular.module("DorfKetalMVCApp").filter('ageFilter', function () {
...
//Roman Number Filter
angular.module("DorfKetalMVCApp").filter('romanNumber', function () {
    return function (num) {
...
// set Decimal
angular.module("DorfKetalMVCApp").filter('setDecimal', function ($filter) {
...
angular.module("DorfKetalMVCApp").filter('countCharactersRemaining', ["$filter", function ($filter) {
